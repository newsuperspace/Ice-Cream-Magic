...
var magicBullet = require('magicBullet');
...
var NodePool = cc.Class({
    ...
    init () {
        ...
        for ( let i = 0; i < this.size; ++i ) {
            ...
            // if(obj.getComponent('magicBullet') instanceof  magicBullet)
            //     cc.log('magicBullet has created!');
    ...
    // 获取一个敌人实例
    request ()  {
        if ( this.getLength() <= 0 ) {  // 如果引用已经小于0，则说明外部引用容器中已经没有剩余节点对象可供使用了
