...
cc.Class({
    ...
    update: function (dt) {
        ...
        broadcast.skill1CDpercent = playerScript.magicFallPrepareTime / playerScript.magicFallCD;
        broadcast.skill2CDpercent = playerScript.magicGouPrepareTime / playerScript.magicGouCD;

        // 如果攻击位置存在 且 技能CD完成，则可以发动技能
